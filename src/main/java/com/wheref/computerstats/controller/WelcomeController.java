...
public class WelcomeController {
    ...
    private static Map<String, Object> printServices(OperatingSystem os) {
        ...
        oshi.put("RunningProcess", runningList);
        oshi.put("StoppedProcess", stoppedList);
        return oshi;
    }

    private static Map<String, Object> printSensors(Sensors sensors) {
        Map<String, Object> oshi = new LinkedHashMap<>();
        oshi.put("Sensors", sensors);
        return oshi;
    }
    ...
    private static Map<String, Object> printFileSystem(FileSystem fileSystem) {
        ...
        oshi.put("OpenFileDescriptors", fileSystem.getOpenFileDescriptors());
        oshi.put("MaxFileDescriptors", fileSystem.getMaxFileDescriptors());

        for (OSFileStore fs : fileSystem.getFileStores()) {
            Map<String, Object> map = new LinkedHashMap<>();
            map.put("UsableSpace", fs.getUsableSpace());
            map.put("TotalSpaceme", fs.getTotalSpace());
            map.put("Name", fs.getName());
            map.put("Description", fs.getDescription());
            map.put("Type", fs.getType());
            map.put("FreeInodes", fs.getFreeInodes());
            map.put("TotalInodes", fs.getTotalInodes());
            map.put("Volume", fs.getVolume());
            map.put("LogicalVolume", fs.getLogicalVolume());
    ...
    private static Map<String, Object> printNetworkInterfaces(List<NetworkIF> list) {
        ...
        for (NetworkIF net : list) {
            oshi.put("NetworkInterfaces", net);
        }
